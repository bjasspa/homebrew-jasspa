...
class MicroemacsMew < Formula
  ...
  if OS.linux?
    ...
    url "#{URLPFX}/Jasspa_MicroEmacs_20240903_bin_linux_binaries.zip"
    ...
    if Hardware::CPU.arm?
      ...
      url "#{URLPFX}/Jasspa_MicroEmacs_20240903_bin_macos_apple_binaries.zip"
      sha256 "840E128556F9D772FCF88CBFFACA1A026C05041FD6B168C6ACF9DDA9B8259D3D"
    elsif Hardware::CPU.intel?
      ZIPPFX="bin/macos13-intel64"
      url "#{URLPFX}/Jasspa_MicroEmacs_20240903_bin_macos_intel_binaries.zip"
